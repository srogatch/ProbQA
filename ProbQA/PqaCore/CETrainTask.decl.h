...
public: // methods
  explicit CETrainTask(CpuEngine<taNumber> &ce, const SRPlat::SRSubtaskCount nWorkers,
    const TPqaId iTarget, const AnsweredQuestion* const pAQs, const TPqaAmount amount);
