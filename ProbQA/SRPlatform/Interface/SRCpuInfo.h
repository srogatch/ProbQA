...
public:
  ...
  static const uint8_t _logCacheLineBytes = 6;
  static const uint8_t _nLogicalCoresPerPhysCore = 2;
  static const uint16_t _cacheLineBytes = 1 << _logCacheLineBytes;
  static const uintptr_t _cacheLineMask = _cacheLineBytes - 1;
};
